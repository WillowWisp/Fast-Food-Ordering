...
class SideBar extends React.Component {
  state = {
    currentUser: null,
    routes: ["Home", "Cart", "AddressList", "FAQ", "CustomBurger", "Location", "SignIn"],
    iconName: ["home", "md-cart", "md-pin", "md-cloud", "md-cart", "home", "wifi"],
    routeName: ["Home", "Your Cart", "Sổ địa chỉ", "FAQ", "Customize Burger", "Locate Us", "Sign In"],
  };
