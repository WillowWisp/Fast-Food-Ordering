...
class SideBar extends React.Component {
  state = {
    currentUser: null,
    routes: ["Home", "Cart", "OrderHistory","AddressList", "FAQ", "SignIn"],
    iconName: ["home", "md-cart", "md-albums", "md-pin", "md-cloud", "wifi"],
    routeName: ["Home", "Giỏ hàng", "Quản lí đơn hàng","Sổ địa chỉ", "FAQ", "Sign In"],
  };
